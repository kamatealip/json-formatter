        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none text-muted-foreground space-y-8 text-lg leading-relaxed">
            <section className="space-y-4">
              ...
              <p>
                By accessing and using KodaJSON, you accept and agree to be bound by the terms and provision of this agreement. In addition, when using KodaJSON services, you shall be subject to any posted guidelines or rules applicable to such services.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                You understand that all information, data, text, or other materials (&quot;Content&quot;), whether publicly posted or privately transmitted, are the sole responsibility of the person from whom such Content originated. This means that you, and not KodaJSON, are entirely responsible for all Content that you upload, post, email, transmit or otherwise make available via the Service.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                KodaJSON reserves the right at any time and from time to time to modify or discontinue, temporarily or permanently, the Service (or any part thereof) with or without notice. You agree that KodaJSON shall not be liable to you or to any third party for any modification, suspension or discontinuance of the Service.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p>
                You agree that KodaJSON may, under certain circumstances and without prior notice, immediately terminate your access to the Service. Cause for such termination shall include, but not be limited to, breaches or violations of the Terms & Conditions or other incorporated agreements or guidelines.
              </p>
            </section>
            ...
            <section className="space-y-4 pt-12 border-t border-border">
              ...
              <p>
                If you have any questions about these Terms & Conditions, please contact us at <Link href="mailto:legal@kodajson.com" className="text-primary hover:underline">legal@kodajson.com</Link>.
              </p>
            </section>
          </div>
        </div>
