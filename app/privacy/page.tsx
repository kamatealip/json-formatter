        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-invert max-w-none text-muted-foreground space-y-8 text-lg leading-relaxed">
            <p className="text-xl text-foreground font-medium">
              Your privacy is not a feature; it is our foundation. KodaJSON is designed to ensure your data never leaves your machine.
            </p>

            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-foreground">1. Data Processing</h2>
              <p>
                KodaJSON is a client-side application. When you paste, upload, or drag-and-drop JSON data into our tool, all formatting, validation, and repair operations are performed locally in your browser&apos;s memory using JavaScript and Web Workers. 
              </p>
            ...
            <section className="space-y-4 pt-12 border-t border-border">
              ...
              <p>
                If you have any questions about this Privacy Policy, please contact us at <Link href="mailto:privacy@kodajson.com" className="text-primary hover:underline">privacy@kodajson.com</Link>.
              </p>
            </section>
          </div>
        </div>
